...
interface AuthContextValue {
  ...
  /** True if the caller can assign/reassign a conversation's
   *  assigned_agent_id (owner/admin/gerencia/jefe_linea/atc — NOT
   *  agent, even though agent passes canSendMessages). Backed at the
   *  DB layer by enforce_conversation_assignment_column() (migration
   *  038) since assignment writes go straight from the browser. */
