    ...
    <div className={cn('flex min-w-0 flex-1 flex-col', DOODLE_BG_CLASSES)}>
      ...
      <div className="border-border bg-card flex items-center justify-between gap-2 border-b px-3 py-3 sm:px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Assign dropdown — read-only for roles that can't reassign
              (Asesor). The DB trigger enforce_conversation_assignment_column
              (migration 038) is what actually blocks the write; this is
              just avoiding showing an interactive control that would
              always fail with a toast for those roles. */}
