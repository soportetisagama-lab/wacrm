    ...
    <header className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-white/10 bg-[linear-gradient(135deg,var(--header-bg)_0%,var(--header-bg-2)_100%)] px-4 lg:px-6">
      <div className="flex min-w-0 items-center gap-2">
        ...
        <div className="hidden shrink-0 items-center gap-1.5 sm:flex">
          <FullscreenToggle className="h-10 w-10 shrink-0 rounded-full border-2 border-white/15 bg-white text-[#006fb5] shadow-[0_3px_10px_rgba(0,0,0,0.25)] transition-all duration-300 hover:scale-[1.07] hover:border-white/30 hover:bg-[#162028] hover:text-white" />
          {onToggleSidebarCollapsed && (
            <SidebarCollapseToggle
              collapsed={sidebarCollapsed}
              onToggle={onToggleSidebarCollapsed}
              className="h-10 w-10 shrink-0 rounded-full border-2 border-white/15 bg-white text-[#006fb5] shadow-[0_3px_10px_rgba(0,0,0,0.25)] transition-all duration-300 hover:scale-[1.07] hover:border-white/30 hover:bg-[#162028] hover:text-white"
            />
          )}
        </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5">
        <ModeToggle className="h-10 w-10 shrink-0 rounded-full border-2 border-white/15 bg-white text-[#006fb5] shadow-[0_3px_10px_rgba(0,0,0,0.25)] transition-all duration-300 hover:scale-[1.07] hover:border-white/30 hover:bg-[#162028] hover:text-white" />
        ...
        >
          <Avatar className="size-8 border-2 border-white/90 shadow-[0_2px_8px_rgba(0,0,0,0.15)] after:border-white/70">
            ...
            <AvatarFallback className="bg-white text-sm font-medium text-[#006fb5]">
              {initial}
            </AvatarFallback>
          </Avatar>
