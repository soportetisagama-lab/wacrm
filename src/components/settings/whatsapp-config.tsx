  ...
  async function handleSave() {
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error(t('reenterTokenRequired'));
        setSaving(false);
        return;
      }
      ...
      if (data.registered === false && data.registration_error) {
        toast.error(
          t('savedButRegisterFailed', { error: data.registration_error }),
          { duration: 12000 },
        );
        ...
        toast.success(
          data.phone_info?.verified_name
            ? t('savedLiveWithName', { name: data.phone_info.verified_name })
            : t('savedConnectedGeneric'),
        );
      ...
      if (payload.connected) {
        ...
        toast.success(
          payload.phone_info?.verified_name
            ? t('testConnectedWithName', { name: payload.phone_info.verified_name })
