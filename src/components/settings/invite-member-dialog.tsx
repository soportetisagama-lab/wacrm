...
// Invite offers only the 4 business-facing roles. 'admin' stays a
// valid, functioning role (see src/lib/auth/roles.ts) but is no
// longer offered at invite time — promote an existing member to it
...
export function InviteMemberDialog({
  ...
  async function handleCreate() {
    ...
    try {
      ...
      toast.error(t('createUnreachable'));
    } finally {
      setSubmitting(false);
    }
  }
